...
// Node metadata
static const char* NODE_ID = "node-02";

// Single-appliance node configuration
static const int NUM_CHANNELS = 1;
static const int SENSOR_PINS[NUM_CHANNELS] = {34};
static const char* APPLIANCE_IDS[NUM_CHANNELS] = {"appliance-02"};
static const char* APPLIANCE_NAMES[NUM_CHANNELS] = {"Node 2"};
...
static const float POWER_THRESHOLDS_W[NUM_CHANNELS] = {800.0f};
